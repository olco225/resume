<?php
// source: C:\wamp64\www\zivotopis-nette/config/common.neon
// source: C:\wamp64\www\zivotopis-nette/config/services.neon
// source: array
...
class Container_8062a7108b extends Nette\DI\Container
{
	...
	public function createService02(): App\Model\resumeFacade
	{
		return new App\Model\resumeFacade($this->getService('database.default.connection'));
	}
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\wamp64\www\zivotopis-nette/temp/cache/nette.application/touch',
		));
	...
	public function createServiceAssets__registry(): Nette\Assets\Registry
	{
		...
		$service->addMapper(
			...
			rtrim(Nette\Utils\FileSystem::resolvePath('C:\wamp64\www\zivotopis-nette\www', 'assets'), '\/'),
			[],
			true,
		),
		);
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('C:\wamp64\www\zivotopis-nette/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('C:\wamp64\www\zivotopis-nette/temp/cache', $this->getService('cache.journal'));
	}
	...
	public function createServiceDatabase__default__connection(): Nette\Database\Connection
	{
		$service = new Nette\Database\Connection(
			'mysql:host=127.0.0.1;dbname=zivotopis',
			/*sensitive{*/'root'/*}*/,
			/*sensitive{*/''/*}*/,
			[],
		);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_8062a7108b $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\wamp64\www\zivotopis-nette/temp/cache/latte');
